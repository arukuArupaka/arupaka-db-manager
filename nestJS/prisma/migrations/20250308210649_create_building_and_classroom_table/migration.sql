/*
  ...
  - A unique constraint covering the columns `[academic,school_year,semester,class_code,weekday,period]` on the table `Lecture` will be added. If there are existing duplicate values, this will fail.
